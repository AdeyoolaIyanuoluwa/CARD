...
const  Assign =(ex)=> {
    ...
    return(
        <>
        <center className="container text-white">
            <h1 className="fw-bold mt-5 rounded-pill que">QUESTIONS</h1>
                 ...
                 <div key={i} className="m-2">
                    ...
                    <div >
                        <div className='text'>
                            <div>
                                <h4 className="bg rounded-pill p-4 ">{i + 1}.{each.question}</h4>
                            </div>
                        ...
                        {newQuestion < 1?
                            ...
                            <button className='mt-4 btn shadow fw-bold' onClick={prevQuestion}>
                                <Link to={`/question/${i}`}>Previous</Link>
                            </button>
                        }
                            ...
                            <button className='mt-4 btn shadow fw-bold' onClick={nextQuestion}>
                                <Link to={`/question/${i + 2}`}>Next</Link>
                            </button>
                              }
